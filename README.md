...
Este projeto utiliza uma abordagem *IP-centric*. Cada submódulo possui seu próprio diretório isolado contendo seu código fonte (RTL) e seu respectivo Testbench (TB):
